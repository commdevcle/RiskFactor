...
The Department of Community Development utilizes the activities’ Risk Factor scores to prioritize its 20 annual monitorings (4 by quarter) by dividing the activities among the three levels of risk classification. The Department of Community Development distributes 25% of its 20 annual monitorings to the low risk classification, 25% to the medium risk classification, and 50% to the high-risk classification. This division allows the Department of Community Development to better leverage its time and provide a stronger monitoring focus on high-risk activities. The overall monitoring number of 40 is about 27% of the total projects in the PR02 report.
